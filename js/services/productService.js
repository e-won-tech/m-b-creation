(function () {
  ...
  const PRODUCT_COLUMNS = "id, shop_id, category_id, category_name, name, pack, price, description, usage_rate, icon_name, image_url, image_public_id, image2_url, image2_public_id, stock, featured, active, sort_order, created_at, updated_at";
  const CSV_COLUMNS = ["category_name", "name", "pack", "price", "description", "usage_rate", "icon_name", "image_url", "image2_url", "stock", "featured", "active", "sort_order"];
